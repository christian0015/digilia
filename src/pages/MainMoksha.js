...
import MeshMoksha from "./projetMakerCentral/components/MeshMoksha";
...
const ProjetPage = () => {
  ...
  const storedComponents = JSON.parse(localStorage.getItem('MeshMokshaComponents'))|| [];
  ...
  useEffect(() => {
      localStorage.setItem("MeshMokshaComponents", JSON.stringify(components));
    }, [components]);
  ...
  // ***************** Debut Liste MeshMoksha***************** //
  // *****************                    ***************** //
  const AddMeshMoksha = () => {  
    return (
      <div>
        <h1>MeshMoksha Editor</h1>
        {/* <MeshMoksha onAddMeshMoksha={handleAddMeshMoksha} /> */}
        <MeshMoksha onAddContainer={handleAddContainer} />
      </div>
    );
  };
  // ***************** Fin Liste MeshMoksha ***************** //
  // *****************                    ***************** //
  return (
    <div>
      <div className="projet-maker">
        ...
        <div className={isShown ? 'show container-rigth-projet-maker' : 'container-rigth-projet-maker'}>
          ...
          <div className="container-rigth-projet-maker-links">
            ...
            <NavLink onClick={() => handleComponentChange(<AddMeshMoksha />)}>
              <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="m354-287 126-76 126 77-33-144 111-96-146-13-58-136-58 135-146 13 111 97-33 143ZM233-120l65-281L80-590l288-25 112-265 112 265 288 25-218 189 65 281-247-149-247 149Zm247-350Z"/></svg>
              <span>AddMeshMoksha</span>
            </NavLink >
